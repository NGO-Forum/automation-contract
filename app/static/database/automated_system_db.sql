...
CREATE TABLE `employees` (
  ...
  `representative_title` varchar(100) DEFAULT NULL,
  `organization_address` text DEFAULT NULL,
  `organization_tel` varchar(50) DEFAULT NULL,
  `organization_fax` varchar(50) DEFAULT NULL,
  `organization_email` varchar(150) DEFAULT NULL,
  `employee_name` varchar(255) NOT NULL,
  `employee_address` text DEFAULT NULL,
  `employee_tel` varchar(50) DEFAULT NULL,
  ...
  `salary_amount_words` varchar(255) DEFAULT NULL,
  `medical_allowance` decimal(10,2) DEFAULT NULL,
  `child_education_allowance` decimal(10,2) DEFAULT NULL,
  `delivery_benefit` decimal(10,2) DEFAULT NULL,
  `delivery_benefit_miscarriage` decimal(10,2) DEFAULT NULL,
  `death_benefit` decimal(10,2) DEFAULT NULL,
  `severance_percentage` decimal(5,2) DEFAULT NULL,
  `thirteenth_month_salary` tinyint(1) DEFAULT NULL,
  `employer_signature_name` varchar(150) DEFAULT NULL,
  `employee_signature_name` varchar(150) DEFAULT NULL,
...
('19f6da01-8603-4a29-873a-14c59aff5d05', 'NGOF-FDC/001', 'Undefined Duration Contract (UDC)', 'The NGO Forum on Cambodia', 'Mr. Soeung Saroeun', 'Executive Director', '#9-11, St. 476, Sangkat Toul Tompong I, Khan Chamka Morn, Phnom Penh, Cambodia', '023 214 429', '023 994 063', 'info@ngoforum.org.kh', 'Mr. Som Chettana', '271\r\nPhnom Penh', '013234535', 'som@ngoforum.org.kh', 'Finance and opperiater Manager', '2025-02-01', '2026-02-01', 'Monday to Friday: 08:00am-12:00pm and 01:30pm-05:30pm', 1200.00, 'G4/L5', 'One Thousand Two Hundred US Dollars only', 150.00, 60.00, 200.00, 200.00, 200.00, 8.33, 1, 'Mr. Soeung Saroeun', 'Mr. Som Chettana', '2025-02-01', '2025-02-01', 'active', '2025-10-22 09:49:57', '2025-10-24 01:40:53', NULL),
('602803d2-bff3-41be-a8e9-433c1b2bd8a5', 'NGOF-FDC/001', 'Fixed Duration Contract (FDC)', 'The NGO Forum on Cambodia', 'Mr. Soeung Saroeun', 'Executive Director', '#9-11, St. 476, Sangkat Toul Tompong I, Khan Chamka Morn, Phnom Penh, Cambodia', '023 214 429', '023 994 063', 'info@ngoforum.org.kh', 'Mr. Chan Vicheth', '#155, St.113, Sangkat Boeung Keng Kang III, Khan Boeung Keng Kang, Phnom Penh.', '012 953 650', 'vichethchan@gmail.com', 'Capacity Development Specialist', '2025-01-01', '2026-01-01', 'Monday to Friday: 08:00am-12:00pm and 01:30pm-05:30pm', 1225.00, 'G4/L5', 'One Thousand Two Hundred Twenty-five US Dollars only', 150.00, 60.00, 200.00, 200.00, 200.00, 8.33, 1, 'Mr. Soeung Saroeun', 'Mr. Chan Vicheth', '2025-01-01', '2025-01-01', 'active', '2025-10-22 08:34:12', '2025-10-24 01:40:32', NULL);
...
('22245edc-3aca-4cb7-80c6-02ae30a9da9e', 'Mr. MangSeu Sork', 'IT-Intern', '271 Phnom Penh', '+85567408241', 'mangeseu.sork@student.passerellesnumeriques.org', '2025-08-05', '6 months', '2026-02-05', '8:00am – 5:00pm, Monday to Friday', 150.00, 1, '{\"title\": \"RITI Program Manager\", \"name\": \"Mr. CHAN Vicheth\"}', 'Mr. Soeung Saroeun', 'Executive Director', '#9-11, St. 476, Sangkat ToulTompong I, Khan Chamka Morn, Phnom Penh, Cambodia', '023 214 429', '023 994 063', 'info@ngoforum.org.kh', '2025-10-24 02:43:14', NULL),
('31e99418-9195-4556-ac41-69c2a5a3655d', 'Mr. Chhea Chhouy', 'IT-Intern', 'BP 511, Phum Tropeang Chhuk (Borey Sorla) Sangtak, Street 371, Phnom Penh', '+85567408241', 'chhea.chhouy@student.passerellesnumeriques.org', '2025-08-05', '6 months', '2026-02-05', '8:00am – 5:00pm, Monday to Friday', 150.00, 1, '{\"title\": \"MACOR Program Manager\", \"name\": \"Mr. SOM Chettana\"}', 'Mr. Soeung Saroeun', 'Executive Director', '#9-11, St. 476, Sangkat ToulTompong I, Khan Chamka Morn, Phnom Penh, Cambodia', '023 214 429', '023 994 063', 'info@ngoforum.org.kh', '2025-10-24 02:43:14', NULL),
('97183329-cde2-40a2-9a36-f12f65351044', 'Ms. Dorn Sochea', 'Finance and Administrative Intern', 'BP 511, Phum Tropeang Chhuk (Borey Sorla) Sangtak, Street 371, Phnom Penh', '+85567408241', 'socheadorn@gmail.com', '2025-08-18', '3 months', '2025-11-18', '8:00am – 5:00pm, Monday to Friday', 150.00, 1, '{\"title\": \"MACOR Program Manager\", \"name\": \"Mr. SOM Chettana\"}', 'Mr. Soeung Saroeun', 'Executive Director', '#9-11, St. 476, Sangkat ToulTompong I, Khan Chamka Morn, Phnom Penh, Cambodia', '023 214 429', '023 994 063', 'info@ngoforum.org.kh', '2025-10-24 02:43:14', NULL),
('ad77f660-1439-4ab2-8af6-6e64cffc089e', 'Mr. Oeun Romas', 'PILI-intern', 'BP 511, Phum Tropeang Chhuk (Borey Sorla) Sangtak, Street 371, Phnom Penh', '+85567408241', 'oeun.romas@gmail.com', '2025-09-10', '3 months', '2025-12-10', '8:00am – 5:00pm, Monday to Friday', 200.00, 1, '{\"title\": \"PALI Program Manager\", \"name\": \"Mr. MAR Sophal\"}', 'Mr. Soeung Saroeun', 'Executive Director', '#9-11, St. 476, Sangkat ToulTompong I, Khan Chamka Morn, Phnom Penh, Cambodia', '023 214 429', '023 994 063', 'info@ngoforum.org.kh', '2025-10-24 02:43:14', NULL),
('c52dccb4-3b59-4783-972f-3a2643dbea69', 'Mr. Khun Virakyuth', 'SACHAS -Intern', 'BP 511, Phum Tropeang Chhuk (Borey Sorla) Sangtak, Street 371, Phnom Penh', '+855 67408241', 'virakyuth.khun@gmail.com', '2025-07-01', '3 months', '2025-10-01', '8:00am – 5:00pm, Monday to Friday', 250.00, 1, '{\"title\": \"SACHAS Program Manager\", \"name\": \"Ms. OUM Somaly\"}', 'Mr. Soeung Saroeun', 'Executive Director', '#9-11, St. 476, Sangkat ToulTompong I, Khan Chamka Morn, Phnom Penh, Cambodia', '023 214 429', '023 994 063', 'info@ngoforum.org.kh', '2025-10-24 02:43:14', NULL);
...
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `notifications_ibfk_1` FOREIGN KEY (`creator_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `notifications_ibfk_2` FOREIGN KEY (`recipient_id`) REFERENCES `user` (`id`),
  ADD CONSTRAINT `notifications_ibfk_3` FOREIGN KEY (`related_contract_id`) REFERENCES `contracts` (`id`);

--
-- Constraints for table `role_permissions`
--
ALTER TABLE `role_permissions`
  ADD CONSTRAINT `role_permissions_ibfk_1` FOREIGN KEY (`permission_id`) REFERENCES `permission` (`id`),
  ADD CONSTRAINT `role_permissions_ibfk_2` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`);
